...
const items: Array<{ track: Track; href: string; zh: string; en: string; descriptionZh: string; descriptionEn: string }> = [
  ...
  { track: "research", href: "/research", zh: "数学科研", en: "Mathematical research", descriptionZh: "中学生科研项目、数学社会实践、申请资格、费用与成果。", descriptionEn: "Research programs, mathematics in social practice, eligibility, cost and outputs." },
