...
export const europeAssessmentSources: SourceRecord[] = [
  ...
  source("eu-cisia-tolci-pdf", "English TOLC-I 旧版数学考纲 PDF", "Legacy English TOLC-I syllabus PDF", "CISIA", "CISIA", "https://www.cisiaonline.it/sites/default/files/2023/Sillabi/Syllabus-English-TOLC-I.pdf", "official-archive", "Legacy English TOLC-I; replaced by CEnT-S from late November 2025"),
  ...
  sections: [
    {
      ...
      tables: [{
        ...
        rows: [
          ...
          row([["English TOLC-I", "English TOLC-I"], ["旧考试，已被替代", "Legacy test, replaced"], ["历史英语版本；不再是新周期的现行考试。", "Historical English version; no longer the current test for new cycles."], ["自 2025 年 11 月起不应再按旧 English TOLC-I 准备新周期；旧考纲只作历史参考。", "Do not prepare for a new-cycle sitting under the old English TOLC-I after November 2025; its syllabus is retained only as a historical reference."]], ["eu-cisia-cent-overview", "eu-cisia-tolci-pdf"]),
