...
export default function Page() {
  ...
  return <CategoryGateway title={t("课程与考试", "Courses and tests")} description={t("国际课程数学和入学考试分开整理；考试页只保留数学或定量部分。", "International mathematics curricula and admissions tests are separate; test records cover only mathematics or quantitative sections.")} items={[
